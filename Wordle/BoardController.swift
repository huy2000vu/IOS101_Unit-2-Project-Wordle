...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numLetters = settings[kNumLettersKey] as? Int else{
          assertionFailure("Received a non-int value")
          return
      }
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let numGuess = settings[kNumGuessesKey] as? Int else{
          assertionFailure("Received something that's not int")
          return
      }
      numRows=numGuess
    // END YOUR CODE HERE
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      guard let alienFlag = settings[kIsAlienWordleKey] as? Bool else{
          assertionFailure()
          return
      }
      isAlienWordle = alienFlag
    // START YOUR CODE HERE
  }
}
